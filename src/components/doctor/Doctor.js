...
function Doctor(props) {
  ...
  useEffect(() => {
    fetch(
      `https://dashboard.nabdmed.com/api/doctors-servicse-pagination?page=${currentPage}`
    )
      .then((res) => res.json())
      .then((data) => {
                  ...
                  <div>
                    ...
                    <div className="review">
                      ...
                      >
                        ...
                        <p className="review2">({doctor.ratings_count} {props.langs === "en" ? "التقييمات" : "Reviews"})</p>
                      </Link>
                    </div>
