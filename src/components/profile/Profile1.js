...
import img1 from "../../imges/user-square.png";
import img2 from "../../imges/man.png";
  ...
  let deleteProduct = (itme) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(
          `https://dashboard.nabdmed.com/api/delete-user-relatives/${itme.id}`,
          {
            method: "DELETE",
            headers: {
              Authorization: `Bearer ${token}`,
          ...
          <div className="info">
            ...
            <div>
              ...
              <div className="info-info">
                ...
                <p>
                  <img src={img2} alt="..." />
                  <span>{itme.gender === "1" ? `${lang === "ar" ? "man" : "ذكر"}` : `${lang === "ar" ? "woman" : "انثى"}`}</span>
                </p>
              </div>
            </div>
          </div>
