...
import imglogo from "../../imges/صورة واتساب بتاريخ 1446-04-18 في 18.20.20_9ac20cfe.jpg";
import infocircle from "../../imges/info-circle.png";
import Calendar from "../../imges/Calendar.png"
import location from "../../imges/location@2x.png"
import ticketdiscount from "../../imges/ticket-discount.png"
import {
  MapContainer,
  TileLayer,
  Marker,
...
function Doctorservicemodel(props) {
  ...
  function Doctorserviceshow() {
    fetch(`https://dashboard.nabdmed.com/api/doctors-services-show/${id}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  function showReviews() {
    fetch(`https://dashboard.nabdmed.com/api/services-review/${id}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  let appiyCoupon = async () => {
    try {
      let res = await axios.post(
        "https://dashboard.nabdmed.com/api/apply-coupon",
        {
          coupon_code: code,
  ...
  async function dataUser() {
    ...
    try {
      let res = await fetch(
        `https://dashboard.nabdmed.com/api/user-relatives`,
        {
          method: "GET",
          headers: {
  ...
  function dataDate() {
    fetch(`https://dashboard.nabdmed.com/api/doctor-dates/${idDoctor}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  function hours() {
    if (idDay === null) {
      ...
      fetch(`https://dashboard.nabdmed.com/api/doctor-hours/${idDay}`)
        .then((res) => res.json())
        .then((data) => {
          sethourss(data.data);
        });
  ...
  async function formSubmit(e) {
    ...
    if (window.localStorage.getItem("email")) {
      try {
        let res = await axios.post(
          "https://dashboard.nabdmed.com/api/add-service-rating",
          {
            message: message,
            rating: userRating,
            service_id: id,
  ...
  async function postData(e) {
    ...
    if (window.localStorage.getItem("email")) {
      ...
      try {
        let res = await axios.post(
          "https://dashboard.nabdmed.com/api/add-order",
          {
                      ...
                      showreviewsservice.map((item) => (
                        <div key={item.id} className="div-itme">
                          <div className="div-info">
                            <div className="img">
                              {item.coveruser === null ? (
                                <img src={imglogo} alt="Default Cover" />
                              ) : (
                ...
                <div className="schedule">
                  ...
                  {datayear.length > 0 ? (
                    <>
                      ...
                      {hourss.length > 0 ? (
                        <div style={{ marginTop: "50px" }} className="times">
                          {hourss.map((itme) => (
                            <NavLink
                              className={`time ${
                                idHour === itme.id ? "hho" : ""
                ...
                <div className="date">
                  ...
                  <div className="coupon">
                    ...
                    <div>
                      ...
                      <input
                        type=" text"
                        placeholder={props.langs === "ar" ? "ُEnter Coupon" : "ادخل الكوبون"}
                        value={code}
                    ...
                    {error === 404 &&
                      `${
                        props.langs === "ar"
                          ...
                          : "الكوبون غير صحيح او منتهي الصلاحية"
                      }`}
                  </p>
                  )}
